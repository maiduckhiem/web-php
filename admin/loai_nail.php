  ...
  <div class="main-header navbar navbar-expand navbar-white navbar-light">
                <table class="table table-hover">
                    <thead>
                        ...
                        <th width="125">
                            <a href="add_loai-nail.php" class="btn btn-danger">Thêm mới</a>
                        </th>
                    </thead>
                    <tbody>
                        <?php foreach ($product as $key => $value) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo BASE_URL ?>admin/edit_loai-nail.php?id=<?= $value['id'] ?>" class="btn btn-danger">edit</a>
                                    <a href="<?= BASE_URL ?>admin/delete_loai_nail.php?id=<?= $value['id'] ?>"  onclick="return confirm('Bạn có chắc chắn muốn xóa ?')" class="btn btn-info">delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
