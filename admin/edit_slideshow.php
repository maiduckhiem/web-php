...
if(isset($_POST['btnAdd'])){
    ...
    if(empty($err)){
        $getDb = "UPDATE slideshow SET title='$text_name', hinh='$luu_anh', detail='$text_detail', status='$text_status', link='$text_link'  WHERE id = '$id' ";
        $connect = getDbConnect();
        $stml = $connect->prepare($getDb);
        $stml->execute();
...
<div class="row">
    ...
    <div class="form-group">
      ...
      <input type="text" name="title" id="" value="<?php echo $cates['title'] ?>" class="form-control" placeholder="" aria-describedby="helpId">
    </div>
    <div class="form-group">
      <label for="">Img</label>
    ...
    <div class="form-group">
      ...
      <input type="text" name="detail" value="<?php echo $cates['detail'] ?>" id="" class="form-control" placeholder="" aria-describedby="helpId">
    </div>
    <div class="form-group">
      <label for="">Status</label>
      <input type="text" name="status" value="<?php echo $cates['status'] ?>" id="" class="form-control" placeholder="" aria-describedby="helpId">
    </div>
    <div class="form-group">
      <label for="">Link</label>
      <input type="text" name="link" id="" value="<?php echo $cates['link'] ?>" class="form-control" placeholder="" aria-describedby="helpId">
    </div>
