      ...
      <div class="">
            ...
            <table class="table table-hover">
                <thead>
                    ...
                    <th width="125">
                        <a href="add_setting.php" class="btn btn-danger">Thêm mới</a>
                    </th>
                </thead>
                <tbody>
                    <?php foreach ($product as $key => $value) { ?>
                        <tr>
                            ...
                            <td>
                                <img src="../content/images/<?= $value['logo'] ?>" width="100px" height="100px" alt="">
                            </td>
                            <td>
                                <a href="<?= BASE_URL ?>admin/edit_setting.php?id=<?= $value['id'] ?>" class="btn btn-danger">edit</a>
                                <a href="<?= BASE_URL ?>admin/delete_setting.php?id=<?= $value['id'] ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa ?')" class="btn btn-info">delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
