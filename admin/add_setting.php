...
if(isset($_POST['btnAdd'])){
    ...
    if(empty($err)){
        $getDb = "INSERT INTO setting (name, phone, address, gmail, logo) values ('$text_name','$text_phone','$text_address','$text_gmail','$ten_anh')";
        $connect = getDbConnect();
        $stml = $connect->prepare($getDb);
        $stml->execute();
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <div class="container">
        ...
        <input type="text" name="gmail" required class="form-control"> <br>
